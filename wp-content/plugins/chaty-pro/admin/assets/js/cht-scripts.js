...
jQuery( function($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".close-chaty-popup-btn", function(e){
            e.stopPropagation();
            $(".chaty-popup").hide();
        ...
        $(document).on("click", ".chaty-popup-outer", function(e){
            $(".chaty-popup").hide();
        });
...
(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        $(document).on("keyup", "#chaty-social-Contact_Us .field-setting-col:not(.chaty-custom-field) .contact-form-field-text", function(){
            var title = $(this).closest(".field-setting-col").attr("data-title");
            if($(this).val() == "") {
                $(this).closest(".field-setting-col").attr("data-order", title);
            } else {
                $(this).closest(".field-setting-col").attr("data-order", title);
            }
        });
...
function save_contact_form_field_order() {
    jQuery("#chaty-social-Contact_Us .field-setting-col:not(.chaty-custom-field) .contact-form-field-text").trigger("keyup");
    var fieldValue = [];
