...
<div class="container <?php echo esc_attr($pro_class) ?>" dir="ltr" id="chaty-container">
    <main class="main">
        ...
        <form id="cht-form" action="options.php" method="POST" enctype="multipart/form-data">
            ...
            <section class="chaty-widget-tab grid grid-cols-1 lg:grid-cols-3 overflow-x-hidden sm:overflow-visible rounded-lg border border-gray-150/40 bg-white step-<?php echo esc_attr($step) ?>" id="chaty-widget-body-tab" data-step="<?php echo esc_attr($step) ?>">
                <!-- tabs and settings -->
